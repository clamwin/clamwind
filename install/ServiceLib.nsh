;-----------------------------------------------------------------------------
; Name:        NSIS SERVICE LIBRARY - servicelib.nsh
; Product:     ClamWin Free Antivirus Installer
;
; Based on the NSIS SERVICE LIBRARY by dselkirk@hotmail.com, Version 1.3,
...
; 28/06/2006 budtse : Adaptations for ClamWin
;
...
!ifndef SERVICELIB
  ...
  !macro FUNC_SERVICE UN
    ...
    lbl_create:
      ...
      ; If the username == 'NULL', use a NULL pointer
      IntCmp $R2 'NULL' 0 lbl_user lbl_user
      StrCpy $R2 0
      lbl_user:
